...
The tutorials (chapters as R markdown files) and source files for this book can be downloaded here: [https://github.com/kazeera/learn-r](https://github.com/kazeera/learn-r). This book was created using bookdown.